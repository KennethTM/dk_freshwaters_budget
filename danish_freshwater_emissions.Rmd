---
title: "Popular science article in danish (Vand & Jord) on the danish freshwater carbon budget"
...
#Denmark lakes pco2 with wind and area
so_pco2_sf <- so_pco2 %>%
...
proj_dic_trans %>% 
  mutate(npp_mean_g_C_watershed_year = npp_mean_mol_watershed_year*12,
         DIC_trans_g_C_year = DIC_trans_mol_year*12) %>%View()
